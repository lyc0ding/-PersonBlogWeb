<template>
  <div class="blog-shell">
    <ScrollPositionKeeper
      ...
      :storage-key="ARTICLE_SCROLL_POSITION_KEY"
    />
    <div class="blog-grid">
            ...
            <div class="post-content">
              ...
              <h2 class="post-title">
                <RouterLink
                  ...
                  @click.stop="handleArticleLinkClick(item)"
                >
                  {{ item.title }}
                </RouterLink>
              </h2>
...
const ARTICLE_SCROLL_POSITION_KEY = 'personblog_article_scroll_top'
...
function handleArticleLinkClick(item) {
  scrollPositionKeeper.value?.save()
  rememberArticlePosition(item)
}
